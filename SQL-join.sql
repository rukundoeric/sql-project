...
WHERE
  goal.teamid = 'GER' -- Show the team1, team2 and player for every goal scored by a player
  -- called Mario
SELECT
  team1,
  team2,
...
FROM
  game
  LEFT JOIN goal -- Didn't take into account that a game could have ended 0-0. So a
